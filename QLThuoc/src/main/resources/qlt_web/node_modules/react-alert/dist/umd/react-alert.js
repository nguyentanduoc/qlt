(function (global, factory) {
  ...
  var Provider = function Provider(_ref) {
    ...
    return React__default.createElement(Context$$1.Provider, {
      value: alertContext
    }, children, root.current && reactDom.createPortal(React__default.createElement(Wrapper, _extends({
      options: {
        position: position,
        containerStyle: containerStyle
      }
    }, props), React__default.createElement(reactTransitionGroup.TransitionGroup, null, alerts.map(function (alert) {
  ...
  var withAlert = function withAlert() {
    ...
    return function (WrappedComponent) {
      var WithAlert = function WithAlert(props) {
