...
import {getAllProduct, getSpectUnit} from '../../../actions/exportAction';
...
class CreateBill extends Component {
  ...
  handleSelection(optionValue, event) {
    if(event.name==="productName"){
      this.props.onGetSpectUnit(optionValue.value);
    }
  }

  render() {
    console.log(this.props.exportReducer.spectUnit);
    return (
      <Card>
        <CardHeader>
                ...
                <CardBody>
                  ...
                  <Form>
                    ...
                    <FormGroup>
                      ...
                      <Select options={this.props.exportReducer.spectUnit}
                              onChange={this.handleSelection.bind(this)}
                              isMulti={false}
                              name={"unit"}/>
                    </FormGroup>
...
const mapDispatchToProps = (dispatch) => ({
  ...
  onGetSpectUnit: (id) => {
    return dispatch(getSpectUnit(id));
  }
})
